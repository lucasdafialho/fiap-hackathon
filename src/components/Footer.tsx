    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="hp-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white font-bold mb-4">Compre</h3>
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Impressoras</a></li>
              ...
              <li><a href="#" className="hover:text-white transition-colors">Tinta e toner</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Downloads e drivers</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Fóruns de comunidade</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Status do pedido</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Registro de produto</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Garantias</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-white font-bold mb-4">HP</h3>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-white transition-colors">Sobre a HP</a></li>
          ...
          <div>
            ...
            <div>
              <h4 className="text-white font-bold mb-2">Inscreva-se para receber ofertas</h4>
              <div className="flex">
                <input 
                  type="email" 
                  placeholder="Seu email" 
                  className="py-2 px-3 text-gray-900 rounded-l-md focus:outline-none focus:ring-1 focus:ring-hp-blue w-full" 
                />
                <button className="bg-hp-blue hover:bg-hp-dark-blue text-white py-2 px-4 rounded-r-md transition-colors">
                  OK
                </button>
              </div>
            </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-sm">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p>© 2023 HP Brasil. Todos os direitos reservados.</p>
